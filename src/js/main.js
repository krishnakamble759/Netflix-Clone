...
export function getAssetPath(path) {
    ...
    // Use Vite's BASE_URL (which we set to /Netflix-Clone/ in vite.config.js)
...
if (addProfileBtn && addProfileModal) {
    addProfileBtn.addEventListener('click', () => {
        ...
        const previewImg = document.getElementById('new-profile-preview');
        if (previewImg) previewImg.src = 'Rectangle 2.svg';
    ...
    saveProfileBtn.addEventListener('click', () => {
        ...
        if (profileToEdit) {
            ...
            const avatarSrc = `Rectangle ${avatarNum}.svg`;
...
const searchMovies = [
    // Continue Watching
    { title: "Night School", img: "continue/night School.svg" },
    { title: "Christmas", img: "continue/christamas.svg" },
    { title: "Designated Survivor", img: "continue/designated.svg" },
    { title: "The Queen", img: "continue/The Queen.jpg" },

    // Popular
    { title: "Barbarians", img: "Popular/barbarians_hd.png" },
    { title: "Before 30", img: "Popular/before_30_hd.png" },
    { title: "Lucifer", img: "Popular/lucifer_hd.png" },
    { title: "Adam Project", img: "Popular/adam_project_hd.png" },
    { title: "Game of Thrones", img: "Popular/game_thrones_hd.png" },
    { title: "Hubbie Halloween", img: "Popular/hubbie_halloween_hd.png" },
    { title: "Loev", img: "Popular/loev_hd.png" },
    { title: "Love Like the Summer", img: "Popular/love like the.png" },
    { title: "What Happened To Monday", img: "Popular/what happened to monday.png" },
    { title: "Things Heard and Seen", img: "Popular/Things Heard.jpg" },

    // Trending
    { title: "The Last Kingdom", img: "Trending/the last kingdom.png" },
    { title: "Switched", img: "Trending/switched.svg" },
    { title: "Vikings", img: "Trending/viking.png" },
    { title: "Better Call Saul", img: "Trending/better call saul.png" },
    { title: "Burning", img: "Trending/burning.png" },
    { title: "Insidious", img: "Trending/insidious.png" },
    { title: "IO", img: "Trending/io.png" },
    { title: "Passing", img: "Trending/passing.png" },
    { title: "Sas", img: "Trending/sas.png" },
    { title: "You", img: "Trending/you.png" },

    // Nigeria Today
    { title: "FBoy Island", img: "Negeria/f_boy.png" },
    { title: "Mosul", img: "Trending/mosul.png" },
    { title: "Army of the Dead", img: "Negeria/army.png" },
    { title: "Babel", img: "Negeria/babel.png" },
    { title: "Daredevil", img: "Negeria/dare_devil.jpg" },
    { title: "El Hoyo 2", img: "Negeria/el_hoyo_2.jpg" },
    { title: "John Wick", img: "Negeria/john_wick.jpg" },
    { title: "Kate", img: "Negeria/Kate.jpg" },
    { title: "Peaky Blinders", img: "Negeria/Peaky.jpg" },

    // My List
    { title: "Blacklist", img: "my list/blacklist.png" },
    { title: "Resurrection", img: "my list/Resurrection.png" },
    { title: "The Losers", img: "my list/The losers.png" },
    { title: "Rebel Ridge", img: "my list/Bell ridge.jpg" },

    // African
    { title: "African Folktales", img: "African/african_folktales.jpg" },
    { title: "Ayanda", img: "African/ayanda.jpg" },
    { title: "Blood & Water", img: "African/blood_and_water.svg" },
    { title: "Blood Sisters", img: "African/blood_sisters.jpg" },
    { title: "Inkabi", img: "African/Inkabi.png" },
    { title: "Merry Men 2", img: "African/merry_men_2.svg" },
    { title: "The Woman King", img: "African/the_woman_king.jpg" },
    { title: "Waka", img: "African/waka.jpg" },
    { title: "Where Hands Touch", img: "African/where_hands_touch.jpg" },
    { title: "Citation", img: "African/citation.jpg" },
    { title: "Oloture", img: "African/oloture.jpg" },

    // Nollywood
    { title: "Prison Break", img: "Nollywood/prison_break.svg" },
    { title: "Suits", img: "Nollywood/Suits.svg" },
    { title: "Greenleaf", img: "Nollywood/Greenleaf.svg" },
    { title: "Broken Love", img: "Nollywood/broken_love.jpg" },
    { title: "Ewo", img: "Nollywood/Ewo.jpg" },
    { title: "Hijack 93", img: "Nollywood/hijack_93.jpg" },
    { title: "Shanty Town", img: "Nollywood/shanty_town.jpg" },
    { title: "Swallow", img: "Nollywood/swallow.jpg" },
    { title: "The Black Book", img: "Nollywood/the_black_book.jpg" },
    { title: "Two Girls", img: "Nollywood/two_girls.jpg" },

    // Originals
    { title: "Fresh Prince", img: "originals/fresh_prince.png" },
    { title: "Extraction", img: "my list/Extraction.png" },
    { title: "Enola Holmes", img: "originals/enola holmes.jpg" },
    { title: "Glass Onion", img: "originals/glass onion.jpg" },
    { title: "Money Heist", img: "originals/money heist.png" },
    { title: "Maestro", img: "originals/Maestro.jpg" },
    { title: "Kasanova", img: "originals/Kasanova.jpg" },
    { title: "International Assassin", img: "originals/International assassin.jpg" },
    { title: "Rebel Ridge", img: "originals/Bell ridge.jpg" },
    { title: "The School for Good and Evil", img: "originals/school_good_evil_hd.png" },

    // Watch Again
    { title: "Big Bang Theory", img: "watch/big bang theory.jpg" },
    { title: "Ayanda", img: "watch/ayanda.jpg" },
    { title: "Living in Bondage Breaking Free", img: "watch/living on bandage.png" },
    { title: "The Old Guard", img: "watch/the old guard.png" },
    { title: "Queen of South", img: "watch/Queen of south.png" },
    { title: "Bad Boys", img: "watch/Bad Boys.jpg" },
    { title: "Better Call Saul", img: "Trending/better call saul.png" },
    { title: "Burning", img: "watch/Burning.jpg" },
    { title: "Insidious", img: "watch/Insidious.jpg" },
    { title: "African Folktales", img: "watch/African Folktales.jpg" },

    // New Release
    { title: "Locked Up", img: "new release/locked up.png" },
    { title: "Sugar Rush", img: "new release/sugar rush.png" },
    { title: "Rez Ball", img: "new release/Rez ball.jpg" },
    { title: "Troll 2", img: "new release/Troll 2.jpg" },
    { title: "Fast X", img: "new release/fast x.png" },
    { title: "Fast & Furious: Hobbs & Shaw", img: "new release/fast and furious.jpg" },
    { title: "Citation", img: "new release/citation.jpg" },
    { title: "Venom", img: "new release/venom.jpg" },
    { title: "The Equalizer 3", img: "new release/the equilizer 3.jpg" },
    { title: "Bad Boys", img: "new release/Bad Boys.jpg" },

    // TV Thriller
    { title: "Lagos Real Fake Life", img: "tv thriller/Lagos real.png" },
    { title: "The Order", img: "tv thriller/The Order.png" },
    { title: "Gangster Paradise", img: "tv thriller/Gangster Paradise.png" },
    { title: "Behind Her Eyes", img: "tv thriller/Behind her eyes.jpg" },
    { title: "Havoc", img: "tv thriller/Havog.jpg" },
    { title: "The Nurse", img: "tv thriller/The Nurse.jpg" },
    { title: "Oxygen", img: "tv thriller/Tv thriller.jpg" },
    { title: "Carry On", img: "tv thriller/carry on.jpg" },
    { title: "Fair Play", img: "tv thriller/fair play.jpg" },
    { title: "The Platform", img: "tv thriller/the platform.jpg" },

    // US TV
    { title: "La Reina del Sur", img: "us tv/lariena.png" },
    { title: "Raising Dion", img: "us tv/Raising dion.png" },
    { title: "The World of The Married", img: "us tv/the married.png" },
    { title: "The Rookie", img: "us tv/The rookie.jpg" },
    { title: "Dark Winds", img: "us tv/dark winds.jpg" },
    { title: "We Are Your Friends", img: "us tv/friends.jpg" },
    { title: "His and Hers", img: "us tv/his and hers.jpg" },
    { title: "Suits", img: "us tv/suites.jpg" },
    { title: "SWAT", img: "us tv/swat.jpg" },
    { title: "You", img: "Trending/you.png" }
];
...
const movieInfoDB = {
    "Lucifer": {
        year: '2016', rating: '18+', genre: ['Crime', 'Fantasy'], hd_img: 'Popular/lucifer_hd.png',
        video: 'trailer/lucifer.mp4',
    ...
    "Barbarians": {
        year: '2020', rating: '18+', genre: ['Action', 'History'], hd_img: 'Popular/barbarians_hd.png',
    ...
    "Adam Project": {
        year: '2022', rating: '13+', genre: ['Sci-Fi', 'Adventure'], hd_img: 'Popular/adam_project_hd.png',
    ...
    "Game of Thrones": {
        year: '2011', rating: '18+', genre: ['Fantasy', 'Drama'], hd_img: 'Popular/game_thrones_hd.png',
        video: 'trailer/game-thrones.mp4',
    ...
    "Money Heist": {
        year: '2017', rating: '18+', genre: ['Crime', 'Thriller'], hd_img: 'originals/money heist.png',
    ...
    "Hubie Halloween": {
        year: '2020', rating: '13+', genre: ['Comedy', 'Mystery'], hd_img: 'Popular/hubbie_halloween_hd.png',
    ...
    "Loev": {
        year: '2015', rating: '18+', genre: ['Romance', 'Drama'], hd_img: 'Popular/loev_hd.png',
        video: 'trailer/lucifer.mp4',
    ...
    "Love Like the Falling Petals": {
        year: '2022', rating: '13+', genre: ['Romance', 'Drama'], hd_img: 'Popular/love like the.png',
        video: 'trailer/money-heist.mp4',
    ...
    "What Happened To Monday": {
        year: '2017', rating: '18+', genre: ['Sci-Fi', 'Thriller'], hd_img: 'Popular/what happened to monday.png',
    ...
    "Fresh Prince": {
        ...
        hd_img: 'originals/fresh_prince.png',
    ...
    "Extraction": {
        year: '2020', rating: '18+', genre: ['Action', 'Thriller'], hd_img: 'my list/Extraction.png',
        video: 'trailer/extraction-bruce-willis-kellan-lutz.mp4',
    ...
    "The Last Kingdom": {
        year: '2015', rating: '18+', genre: ['Action', 'Drama'], hd_img: 'Trending/the last kingdom.png',
    ...
    "Before 30": {
        year: '2015', rating: '16+', genre: ['Drama', 'Nollywood'], hd_img: 'Popular/before_30_hd.png',
        video: 'trailer/vikings.mp4',
        desc: 'Four women living in Lagos are pressured by society and their families to get married before they turn 30.'
    },
    "Switched": {
        year: '2018', rating: '13+', genre: ['Sci-Fi', 'Drama'], hd_img: 'Trending/switched.svg',
    ...
    "Vikings": {
        year: '2013', rating: '18+', genre: ['Action', 'History'], hd_img: 'Trending/viking.png',
        video: 'trailer/vikings.mp4',
    ...
    "Better Call Saul": {
        year: '2015', rating: '18+', genre: ['Crime', 'Drama'], hd_img: 'Trending/better call saul.png',
        video: 'trailer/john-wick-keanu-reeves-willem.mp4',
    ...
    "Burning": {
        year: '2018', rating: '18+', genre: ['Drama', 'Mystery'], hd_img: 'Trending/burning.png',
        video: 'trailer/insidious-james-wan.mp4',
    ...
    "Insidious": {
        year: '2010', rating: '16+', genre: ['Horror', 'Mystery'], hd_img: 'Trending/insidious.png',
        video: 'trailer/insidious-james-wan.mp4',
        desc: 'A family looks to prevent evil spirits from trapping their comatose child in a realm called The Further.'
    },
    "IO": {
        year: '2019', rating: '13+', genre: ['Sci-Fi', 'Adventure'], hd_img: 'Trending/io.png',
    ...
    "Passing": {
        year: '2021', rating: '13+', genre: ['Drama', 'Thriller'], hd_img: 'Trending/passing.png',
        video: 'trailer/money-heist.mp4',
    ...
    "Sas": {
        year: '2021', rating: '18+', genre: ['Action', 'Thriller'], hd_img: 'Trending/sas.png',
    ...
    "You": {
        year: '2018', rating: '18+', genre: ['Crime', 'Drama'], hd_img: 'Trending/you.png',
        video: 'trailer/insidious-james-wan.mp4',
    ...
    // African Movies
    "African Folktales": {
        year: '2023', rating: '7+', genre: ['Anthology', 'Culture'], hd_img: 'African/african_folktales.jpg',
        video: 'trailer/vikings.mp4',
    ...
    "Ayanda": {
        year: '2015', rating: '13+', genre: ['Drama', 'Romance'], hd_img: 'African/ayanda.jpg',
        video: 'trailer/money-heist.mp4',
    ...
    "Blood & Water": {
        year: '2020', rating: '16+', genre: ['Drama', 'Mystery'], hd_img: 'African/blood_and_water.svg',
        video: 'trailer/money-heist.mp4',
    ...
    "Blood Sisters": {
        year: '2022', rating: '18+', genre: ['Thriller', 'Crime'], hd_img: 'African/blood_sisters.jpg',
        video: 'trailer/money-heist.mp4',
    ...
    "Inkabi": {
        year: '2024', rating: '18+', genre: ['Action', 'Thriller'], hd_img: 'African/Inkabi.png',
        video: 'trailer/john-wick-keanu-reeves-willem.mp4',
        desc: 'A retired hitman is pulled back into the underworld to protect a young woman who witnessed a brutal crime.'
    },
    "Merry Men 2": {
        year: '2019', rating: '16+', genre: ['Action', 'Comedy'], hd_img: 'African/merry_men_2.svg',
        video: 'trailer/bad-boys-ride-or-die.mp4',
    ...
    "The Woman King": {
        year: '2022', rating: '16+', genre: ['Action', 'History'], hd_img: 'African/the_woman_king.jpg',
        video: 'trailer/last-kingdom-seven-kings-must.mp4',
    ...
    "Waka": {
        year: '2021', rating: '13+', genre: ['Drama', 'Adventure'], hd_img: 'African/waka.jpg',
        video: 'trailer/vikings.mp4',
    ...
    "Where Hands Touch": {
        year: '2018', rating: '16+', genre: ['Drama', 'War'], hd_img: 'African/where_hands_touch.jpg',
        video: 'trailer/last-kingdom-seven-kings-must.mp4',
    ...
    "FBoy Island": {
        year: '2021', rating: '18+', genre: ['Reality', 'Romance'], hd_img: 'Negeria/f_boy.png',
        video: 'trailer/money-heist.mp4',
    ...
    "Mosul": {
        year: '2020', rating: '18+', genre: ['Action', 'War'], hd_img: 'Trending/mosul.png',
        video: 'trailer/extraction-bruce-willis-kellan-lutz.mp4',
    ...
    "Army of the Dead": {
        year: '2021', rating: '18+', genre: ['Action', 'Horror'], hd_img: 'Negeria/army.png',
        video: 'trailer/fast-x.mp4',
    ...
    "Babel": {
        year: '2006', rating: '18+', genre: ['Drama', 'Thriller'], hd_img: 'Negeria/babel.png',
        video: 'trailer/money-heist.mp4',
    ...
    "Daredevil": {
        year: '2015', rating: '18+', genre: ['Action', 'Crime'], hd_img: 'Negeria/dare_devil.jpg',
    ...
    "El Hoyo 2": {
        year: '2024', rating: '18+', genre: ['Sci-Fi', 'Thriller'], hd_img: 'Negeria/el_hoyo_2.jpg',
        video: 'trailer/troll.mp4',
    ...
    "John Wick": {
        year: '2014', rating: '18+', genre: ['Action', 'Thriller'], hd_img: 'Negeria/john_wick.jpg',
        video: 'trailer/john-wick-keanu-reeves-willem.mp4',
        desc: 'An ex-hit-man comes out of retirement to track down the gangsters that killed his dog and took everything from him.'
    },
    "Kate": {
        year: '2021', rating: '18+', genre: ['Action', 'Thriller'], hd_img: 'Negeria/Kate.jpg',
        video: 'trailer/john-wick-keanu-reeves-willem.mp4',
    ...
    // New Releases
    "Locked Up": {
        year: '2017', rating: '18+', genre: ['Action', 'Thriller'], hd_img: 'new release/locked up.png',
        video: 'trailer/extraction-bruce-willis-kellan-lutz.mp4',
    ...
    "Sugar Rush": {
        year: '2019', rating: '13+', genre: ['Action', 'Comedy'], hd_img: 'new release/sugar rush.png',
        video: 'trailer/fast-furious-presents-hobbs-shaw.mp4',
    ...
    "Rez Ball": {
        year: '2024', rating: '13+', genre: ['Drama', 'Sport'], hd_img: 'new release/Rez ball.jpg',
        video: 'trailer/bad-boys-ride-or-die.mp4',
    ...
    "Troll 2": {
        year: '2022', rating: '13+', genre: ['Action', 'Adventure'], hd_img: 'new release/Troll 2.jpg',
        video: 'trailer/troll.mp4',
        desc: 'Deep inside the mountain of Dovre, something gigantic awakens after being trapped for a thousand years.'
    },
    "Fast X": {
        year: '2023', rating: '13+', genre: ['Action', 'Adventure'], hd_img: 'new release/fast x.png',
        video: 'trailer/fast-x.mp4',
        desc: 'Dom Toretto and his family are targeted by the vengeful son of drug kingpin Hernan Reyes.'
    },
    "Fast & Furious: Hobbs & Shaw": {
        year: '2019', rating: '13+', genre: ['Action', 'Comedy'], hd_img: 'new release/fast and furious.jpg',
        video: 'trailer/fast-furious-presents-hobbs-shaw.mp4',
    ...
    "Citation": {
        year: '2020', rating: '13+', genre: ['Drama', 'Thriller'], hd_img: 'new release/citation.jpg',
        video: 'trailer/money-heist.mp4',
    ...
    "Venom": {
        year: '2018', rating: '13+', genre: ['Action', 'Sci-Fi'], hd_img: 'new release/venom.jpg',
    ...
    "The Equalizer 3": {
        year: '2023', rating: '18+', genre: ['Action', 'Crime'], hd_img: 'new release/the equilizer 3.jpg',
    ...
    "Bad Boys": {
        year: '1995', rating: '18+', genre: ['Action', 'Comedy'], hd_img: 'new release/Bad Boys.jpg',
        video: 'trailer/bad-boys-ride-or-die.mp4',
    ...
    // Nollywood Movies
    "Prison Break": {
        year: '2005', rating: '18+', genre: ['Action', 'Thriller'], hd_img: 'Nollywood/prison_break.svg',
        video: 'trailer/extraction-bruce-willis-kellan-lutz.mp4',
    ...
    "Suits": {
        year: '2011', rating: '16+', genre: ['Drama', 'Comedy'], hd_img: 'Nollywood/Suits.svg',
        video: 'trailer/money-heist.mp4',
    ...
    "Greenleaf": {
        year: '2016', rating: '16+', genre: ['Drama', 'Mystery'], hd_img: 'Nollywood/Greenleaf.svg',
        video: 'trailer/money-heist.mp4',
    ...
    "Broken Love": {
        year: '2020', rating: '13+', genre: ['Romance', 'Drama'], hd_img: 'Nollywood/broken_love.jpg',
        video: 'trailer/money-heist.mp4',
    ...
    "Ewo": {
        year: '2024', rating: '18+', genre: ['Thriller', 'Drama'], hd_img: 'Nollywood/Ewo.jpg',
        video: 'trailer/money-heist.mp4',
    ...
    "Hijack 93": {
        year: '2024', rating: '16+', genre: ['Action', 'History'], hd_img: 'Nollywood/hijack_93.jpg',
        video: 'trailer/fast-x.mp4',
    ...
    "Shanty Town": {
        year: '2023', rating: '18+', genre: ['Crime', 'Thriller'], hd_img: 'Nollywood/shanty_town.jpg',
        video: 'trailer/john-wick-keanu-reeves-willem.mp4',
    ...
    "Swallow": {
        year: '2021', rating: '16+', genre: ['Drama', 'Thriller'], hd_img: 'Nollywood/swallow.jpg',
        video: 'trailer/money-heist.mp4',
    ...
    "The Black Book": {
        year: '2023', rating: '18+', genre: ['Action', 'Thriller'], hd_img: 'Nollywood/the_black_book.jpg',
        video: 'trailer/john-wick-keanu-reeves-willem.mp4',
    ...
    "Two Girls": {
        year: '1997', rating: '13+', genre: ['Comedy', 'Romance'], hd_img: 'Nollywood/two_girls.jpg',
        video: 'trailer/money-heist.mp4',
        desc: 'A charming story about youth, ambition, and the complications of teenage romance in a changing world.'
    },
    // Netflix Originals
    "Fresh Prince": {
        year: '2022', rating: '16+', genre: ['Drama', 'Original'], hd_img: 'originals/fresh_prince.png',
        video: 'trailer/bad-boys-ride-or-die.mp4',
        desc: 'A serialized reimagining of the classic 90s sitcom "The Fresh Prince of Bel-Air" set in modern-day America.'
    },
    "Enola Holmes": {
        year: '2020', rating: '13+', genre: ['Adventure', 'Mystery'], hd_img: 'originals/enola holmes.jpg',
        video: 'trailer/batman-robert-pattinson.mp4',
    ...
    "Glass Onion": {
        year: '2022', rating: '13+', genre: ['Mystery', 'Comedy'], hd_img: 'originals/glass onion.jpg',
        video: 'trailer/extraction-bruce-willis-kellan-lutz.mp4',
    ...
    "Money Heist": {
        year: '2017', rating: '18+', genre: ['Action', 'Thriller'], hd_img: 'originals/money heist.png',
        video: 'trailer/money-heist.mp4',
        desc: 'A group of robbers attempts to carry out the most ambitious heist in Spanish history.'
    },
    "Maestro": {
        year: '2023', rating: '16+', genre: ['Biography', 'Drama'], hd_img: 'originals/Maestro.jpg',
        video: 'trailer/money-heist.mp4',
    ...
    "Kasanova": {
        year: '2019', rating: '13+', genre: ['Romance', 'Comedy'], hd_img: 'originals/Kasanova.jpg',
        video: 'trailer/money-heist.mp4',
    ...
    "International Assassin": {
        year: '2016', rating: '13+', genre: ['Action', 'Comedy'], hd_img: 'originals/International assassin.jpg',
        video: 'trailer/bad-boys-ride-or-die.mp4',
    ...
    "Rebel Ridge": {
        year: '2024', rating: '18+', genre: ['Action', 'Thriller'], hd_img: 'originals/Bell ridge.jpg',
        video: 'trailer/john-wick-keanu-reeves-willem.mp4',
    ...
    "The School for Good and Evil": {
        year: '2022', rating: '13+', genre: ['Fantasy', 'Action'], hd_img: 'originals/school_good_evil_hd.png',
    ...
    "Lagos Real Fake Life": {
        year: '2018', rating: '13+', genre: ['Comedy', 'Thriller'], hd_img: 'tv thriller/Lagos real.png',
        video: 'trailer/bad-boys-ride-or-die.mp4',
    ...
    "The Order": {
        year: '2019', rating: '18+', genre: ['Drama', 'Fantasy'], hd_img: 'tv thriller/The Order.png',
        video: 'trailer/insidious-james-wan.mp4',
    ...
    "Gangster Paradise": {
        year: '2008', rating: '18+', genre: ['Action', 'Crime'], hd_img: 'tv thriller/Gangster Paradise.png',
        video: 'trailer/last-kingdom-seven-kings-must.mp4',
    ...
    "Behind Her Eyes": {
        year: '2021', rating: '18+', genre: ['Mystery', 'Thriller'], hd_img: 'tv thriller/Behind her eyes.jpg',
        video: 'trailer/insidious-james-wan.mp4',
    ...
    "Havoc": {
        year: '2023', rating: '18+', genre: ['Action', 'Thriller'], hd_img: 'tv thriller/Havog.jpg',
        video: 'trailer/extraction-bruce-willis-kellan-lutz.mp4',
    ...
    "The Nurse": {
        year: '2023', rating: '16+', genre: ['Crime', 'Biography'], hd_img: 'tv thriller/The Nurse.jpg',
        video: 'trailer/money-heist.mp4',
    ...
    "Oxygen": {
        year: '2021', rating: '13+', genre: ['Sci-Fi', 'Thriller'], hd_img: 'tv thriller/Tv thriller.jpg',
        video: 'trailer/project-hail-mary.mp4',
    ...
    "Carry On": {
        year: '2024', rating: '13+', genre: ['Action', 'Thriller'], hd_img: 'tv thriller/carry on.jpg',
        video: 'trailer/extraction-bruce-willis-kellan-lutz.mp4',
    ...
    "Fair Play": {
        year: '2023', rating: '18+', genre: ['Drama', 'Thriller'], hd_img: 'tv thriller/fair play.jpg',
        video: 'trailer/money-heist.mp4',
    ...
    "The Platform": {
        year: '2019', rating: '18+', genre: ['Sci-Fi', 'Thriller'], hd_img: 'tv thriller/the platform.jpg',
        video: 'trailer/troll.mp4',
    ...
    // US TV Shows
    "La Reina del Sur": {
        year: '2011', rating: '16+', genre: ['Crime', 'Drama'], hd_img: 'us tv/lariena.png',
        video: 'trailer/money-heist.mp4',
    ...
    "Raising Dion": {
        year: '2019', rating: '13+', genre: ['Action', 'Sci-Fi'], hd_img: 'us tv/Raising dion.png',
        video: 'trailer/avengers-doomsday-robert-downey-jr.mp4',
    ...
    "The World of The Married": {
        year: '2020', rating: '18+', genre: ['Drama', 'Romance'], hd_img: 'us tv/the married.png',
        video: 'trailer/money-heist.mp4',
        desc: 'A story about a married couple whose betrayal of each other leads to a whirlwind of revenge, grief, and healing.'
    },
    "The Rookie": {
        year: '2018', rating: '13+', genre: ['Crime', 'Drama'], hd_img: 'us tv/The rookie.jpg',
        video: 'trailer/bad-boys-ride-or-die.mp4',
    ...
    "Dark Winds": {
        year: '2022', rating: '18+', genre: ['Drama', 'Thriller'], hd_img: 'us tv/dark winds.jpg',
        video: 'trailer/last-kingdom-seven-kings-must.mp4',
    ...
    "We Are Your Friends": {
        year: '2015', rating: '16+', genre: ['Drama', 'Music'], hd_img: 'us tv/friends.jpg',
        video: 'trailer/bad-boys-ride-or-die.mp4',
    ...
    "His and Hers": {
        year: '2024', rating: '18+', genre: ['Thriller', 'Drama'], hd_img: 'us tv/his and hers.jpg',
        video: 'trailer/insidious-james-wan.mp4',
    ...
    "SWAT": {
        year: '2017', rating: '16+', genre: ['Action', 'Crime'], hd_img: 'us tv/swat.jpg',
        video: 'trailer/bad-boys-ride-or-die.mp4',
    ...
    // Watch Again Movies
    "Big Bang Theory": {
        year: '2007', rating: '12+', genre: ['Comedy', 'Sitcom'], hd_img: 'watch/big bang theory.jpg',
        video: 'trailer/bad-boys-ride-or-die.mp4',
    ...
    "Living in Bondage Breaking Free": {
        year: '2019', rating: '18+', genre: ['Drama', 'Thriller'], hd_img: 'watch/living on bandage.png',
        video: 'trailer/money-heist.mp4',
    ...
    "The Old Guard": {
        year: '2020', rating: '18+', genre: ['Action', 'Fantasy'], hd_img: 'watch/the old guard.png',
        video: 'trailer/last-kingdom-seven-kings-must.mp4',
    ...
    "Queen of South": {
        year: '2016', rating: '18+', genre: ['Crime', 'Drama'], hd_img: 'watch/Queen of south.png',
        video: 'trailer/money-heist.mp4',
    ...
    // My List Titles
    "Blacklist": {
        year: '2013', rating: '18+', genre: ['Crime', 'Drama'], hd_img: 'my list/blacklist.png',
        video: 'trailer/john-wick-keanu-reeves-willem.mp4',
    ...
    "Resurrection": {
        year: '2022', rating: '18+', genre: ['Horror', 'Thriller'], hd_img: 'my list/Resurrection.png',
        video: 'trailer/insidious-james-wan.mp4',
    ...
    "The Losers": {
        year: '2010', rating: '18+', genre: ['Action', 'Adventure'], hd_img: 'my list/The losers.png',
        video: 'trailer/bad-boys-ride-or-die.mp4',
        desc: 'A CIA special forces team is betrayed and left for dead by their handler. They band together to exert revenge on the man responsable and clear their names.'
    }
};
...
function openMovieDetails(movie) {
    ...
    const backdropSrc = (dbInfo && dbInfo.hd_img) ? dbInfo.hd_img : movie.img;
    const backdropImg = document.getElementById('modal-backdrop');
    if (backdropImg) backdropImg.src = getAssetPath(backdropSrc);
...
const slideData = [
    ...
    { rank: "#3 in TV Shows Today", video: "trailer/avengers-doomsday-robert-downey-jr.mp4" },
    { rank: "#1 in Nigeria Today", video: "trailer/fast-x.mp4" },
    { rank: "#4 in Movies Today", video: "trailer/bad-boys-ride-or-die.mp4" },
    { rank: "#10 in Nigeria Today", video: "trailer/batman-robert-pattinson.mp4" }
];
...
function openPlayer(videoSrc) {
    ...
    const rawSrc = videoSrc || slideData[currentSlide].video;
    mainVideo.src = getAssetPath(rawSrc);
    mainVideo.load(); // Ensure the new source is loaded
